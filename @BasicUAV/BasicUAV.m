...
classdef BasicUAV < handle   % < handle : pass the value by reference 
    ...
    methods (Access = public)
        ...
        function obj = BasicUAV(x_i, y_i, z_i, psi_i, gamma_i)
            ...
            obj.angle = [psi_i; gamma_i];
            obj.currentState = [obj.currentPos, obj.GetCurrentVel];
            obj.destination = [Xfinal, Yfinal, Zfinal];
            obj.pathOrigin = [Xini, Yini, Zini];
        ...
        function vel = GetCurrentVel(obj)
            ...
            vel = obj.cruisingSpeed * [cos(gamma_i) * cos(psi_i),...
...
%                         obj.SetFlagDanger(1)
        ...
        function UpdateDA(obj) 
            ...
            % Saving states
            obj.currentState = [obj.GetCurrentPos, obj.GetCurrentVel];
            obj.trajectory = [obj.trajectory, obj.currentPos'];
        end
    ...
    methods (Access = protected)
        ...
        Object = create_scene(obj, num, Object, X, Y, Z, rt)
        [uh, uv] = IPN(obj)
