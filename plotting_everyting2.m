...
% Destination
pltDestin = scatter3(leader.DA.destin(1,1), leader.DA.destin(1,2), leader.DA.destin(1,3), 'xr', 'xr', 'sizedata', 150, 'LineWidth', 1.5);

hold on, grid on, axis equal

% if animation
% dxx = leader.DA.traj{rt}(1,end) - leader.DA.traj{rt}(1,1);
% dyy = leader.DA.traj{rt}(2,end)- leader.DA.traj{rt}(2,1);
% dzz = leader.DA.traj{rt}(3,end)- leader.DA.traj{rt}(3,1);
